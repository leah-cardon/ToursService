...
export const checkMark = (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
    <g>
      <rect className="finSvgCheck" data-cb-part="blur" strokeWidth="2" width="18" height="18" x="3" y="3" rx="4" />
      <rect id="finSvgSqr" data-cb-part="background" strokeWidth="2" width="18" height="18" x="3" y="3" rx="4" />
      <path className="finSvgCheck" data-cb-part="check" fill="none" stroke="#FFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 13l2.5 2L15 9" />
    </g>
  </svg>
);
...
const size = { height: '16px', width: '16px' };

export const star = (<svg style={size} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M15.96 3.4l3.7 7.88 8.27 1.264-5.985 6.135 1.412 8.661-7.398-4.09-7.395 4.09 1.411-8.661-5.985-6.135 8.272-1.263z" fill="rgb(242, 196, 48)" fillRule="evenodd" /></svg>);

export const badStar = (<svg style={size} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M15.96 3.4l3.7 7.88 8.27 1.264-5.985 6.135 1.412 8.661-7.398-4.09-7.395 4.09 1.411-8.661-5.985-6.135 8.272-1.263z" fill="#869099" fillRule="evenodd" /></svg>);
